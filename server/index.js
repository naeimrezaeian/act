...
app.get('/questions', (req, res) => {
  ...
  const q_text = [
    ...
    {
      "id": 5003, "type": "text", "desc": "Выберите правильный вариант. Прочитайте сообщения и найдите логическое продолжение этой информации в вариантах", "question": "3-Теперь во все столичные аэропорты можно быстро доехать на электричке из центра Москвы:",
      "answers": [
        { "id": 2009, "answer": "2Например, в московский аэропорт «Внуково» вы доберетесь с Киевского вокзала всего за 30 минут." },
        { "id": 2010, "answer": "2Московское метро — самый удобный и быстрый вид городского транспорта." },
        { "id": 2011, "answer": "2Самый большой аэропорт в Москве — это аэропорт «Домодедово»." },
        { "id": 2012, "answer": "2Самый большой аэропорт в Москве — это аэропорт «Домодедово»." }
      ]
    },
    {
      "id": 5004, "type": "text", "desc": "Выберите правильный вариант. Прочитайте сообщения и найдите логическое продолжение этой информации в вариантах", "question": "4-Теперь во все столичные аэропорты можно быстро доехать на электричке из центра Москвы:",
      "answers": [
        { "id": 2013, "answer": "2Например, в московский аэропорт «Внуково» вы доберетесь с Киевского вокзала всего за 30 минут." },
        { "id": 2014, "answer": "2Московское метро — самый удобный и быстрый вид городского транспорта." },
        { "id": 2015, "answer": "2Самый большой аэропорт в Москве — это аэропорт «Домодедово»." },
        { "id": 2016, "answer": "2Самый большой аэропорт в Москве — это аэропорт «Домодедово»." }
      ]
    },
    {
      "id": 5005, "type": "text", "desc": "Выберите правильный вариант. Прочитайте сообщения и найдите логическое продолжение этой информации в вариантах", "question": "5-Теперь во все столичные аэропорты можно быстро доехать на электричке из центра Москвы:",
      "answers": [
        { "id": 2005, "answer": "2Например, в московский аэропорт «Внуково» вы доберетесь с Киевского вокзала всего за 30 минут." },
        { "id": 2006, "answer": "2Московское метро — самый удобный и быстрый вид городского транспорта." },
        { "id": 2007, "answer": "2Самый большой аэропорт в Москве — это аэропорт «Домодедово»." },
